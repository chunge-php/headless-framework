 ...
 *
 * 约定：
 *  - 控制器命名空间：app\modules\<mod>\http\Controllers\FooController
 *  - 验证器命名空间：app\modules\<mod>\http\Validate\FooValidate
 *  - 场景名：METHOD_action（例如：POST_create / GET_index）
 */
final class ParamValidate implements MiddlewareInterface
{
