...
const params_missing = 2032;//缺失必要参数
const date_range_invalid = 2033;//日期范围无效开始晚于结束
const date_range_too_large = 2034;//日期跨度超过366天
const granularity_invalid = 2035;//聚合粒度参数无效
const type_invalid = 2036;//type参数无效